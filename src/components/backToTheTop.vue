<template>
    <transition name="fade">
        <div id="backToTheTop" @click="backToTop" v-show="isTop">
            <svg t="1701692268366" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                p-id="4461" width="25" height="25">
                <path
